...
@section('content')
                    ...
                    <div class="col-12 col-sm-7" data-aos="zoom-in" data-aos-duration="3000">
                        <div class="cl-desc">
                            ...
                            <p>
                                ...
                                tế danh tiếng, cùng đội ngũ bác sĩ chuyên khoa giàu kinh nghiệm. Qua từng ca phẫu thuật
                                thành công,
                                Dr. Đạt đã mang lại sự tự tin và vẻ đẹp hoàn mỹ cho hàng trăm khách hàng trong và ngoài
                                nước.
                            </p>
                            <hr class="h-hr" />
                            <ul class="cl-ul-desc">
                                <li>
                                    <div class="dv-li-item">
                                        ...
                                        <div class="dv-li-desc">
                                            <h4>Chuyên nghiệp</h4>
                                            <p>
                                                Bằng kinh nghiệm chuyên môn vững vàng và công nghệ, máy móc hiện đại và tiêu
                                                chí chuẩn Y khoa,
                                                Dr. Đạt cùng đội ngũ luôn mang đến những dịch vụ chuyên nghiệp và đẳng cấp
                                                hàng đầu.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="dv-li-item">
                                        ...
                                        <div class="dv-li-desc">
                                            ...
                                            <p>
                                                ...
                                                Dr. Đạt còn là người trực tiếp tư vấn và đồng hành cùng khách hàng xuyên
                                                suốt hành trình tìm lại sự tự tin
                                            </p>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="dv-li-item">
                                        ...
                                        <div class="dv-li-desc">
                                            <h4>Thấu hiểu</h4>
                                            <p>
                                                Tận tuỵ lắng nghe để thấu hiểu mong muốn của từng khách hàng. Đó chính là
                                                phong cách làm việc đặc trưng của
  ...
  @php
    $sec02Banner = \App\Models\Banner::where('section', 'other')->where('is_active', true)->orderBy('order')->first();
@endphp
                        ...
                        <div class="col-12 col-sm-7" data-aos="zoom-in" data-aos-duration="3000">
                            <div class="cl-desc">
                                ...
                                <p>
                                    ...
                                    khách hàng những giải pháp làm đẹp chất lượng cao, hài hòa với nét đẹp tự nhiên và bền
                                    vững theo thời gian.
                                </p>
                                    ...
                                    <li>
                                        <div class="dv-li-item">
                                            ...
                                            <div class="dv-li-desc">
                                                ...
                                                <p>Đặt sự hài lòng và an toàn của khách hàng lên hàng đầu, mang lại vẻ đẹp
                                                    tự nhiên và sự tự tin bền vững.</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="dv-li-item">
                                            ...
                                            <div class="dv-li-desc">
                                                ...
                                                <p>
                                                    ...
                                                    lan tỏa những giá trị tích cực và chuyên môn vchính thổng - chuẩn y
                                                    khoa.
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <li>
                                        <div class="dv-li-item">
                                            ...
                                            <div class="dv-li-desc">
                                                ...
                                                <p>Không ngừng học hỏi, cải thiện kỹ năng và cập nhật công nghệ tiên tiến để
                                                    luôn là người đồng hành đáng tin cậy của khách hàng.</p>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-4">
                            <div class="row m-hover">
                                <div class="col-12 col-sm-12 active it-hover"
                                    data-img="{{ asset('images/home/h_image_sec3_4.png') }}">
                                    <a class="cl-btn-full-2" href="#">
                                        <span>Chứng Chỉ Hành Nghề</span>
                                    </a>
                                </div>
                                <div class="col-12 col-sm-12 it-hover"
                                    data-img="{{ asset('images/home/h_image_sec3_3.png') }}">
                                    <a class="cl-btn-full-2" href="#">
                            ...
                            <div class="cl-sec03-item">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-8 cl-item-center" style="text-align:justify;">
                                        <p>Thẩm Mỹ Tận Tâm Dr. Đạt là đội ngũ bác sĩ PTTHTM có chuyên môn vững vàng với
                                            chứng chỉ hành nghề chuyên khoa được cấp phép bởi Sở Y Tế TP. HCM.</p>
                                        <p>
                                            Tất cả các quy trình thẩm mỹ đều được thực hiện bởi các bác sĩ, bác sĩ trực tiếp
                                            thăm khám, đảm bảo khách hàng sẽ nhận được sự chăm sóc tận
