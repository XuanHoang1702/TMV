...
@section('meta')
    <meta name="description" content="{{ isset($service) ? ($service->meta_description ?? $service->description ?? 'Khám phá các dịch vụ thẩm mỹ tại Dr.DAT.') : (isset($category) ? ($category->meta_description ?? $category->description ?? 'Khám phá các dịch vụ thẩm mỹ tại Dr.DAT.') : 'Khám phá các dịch vụ thẩm mỹ tại Dr.DAT.') }}">
    <meta name="keywords" content="{{ isset($service) ? ($service->meta_keywords ?? 'dịch vụ thẩm mỹ, Dr.DAT, ' . $service->name) : (isset($category) ? ($category->meta_keywords ?? 'dịch vụ thẩm mỹ, Dr.DAT, ' . $category->name) : 'dịch vụ thẩm mỹ, Dr.DAT') }}">
    <meta property="og:title" content="{{ isset($service) ? ($service->name . ' tại Dr.DAT') : (isset($category) ? ($category->name . ' tại Dr.DAT') : 'Dịch vụ thẩm mỹ tại Dr.DAT') }}" />
    <meta property="og:description" content="{{ isset($service) ? ($service->meta_description ?? $service->description ?? 'Khám phá các dịch vụ thẩm mỹ tại Dr.DAT.') : (isset($category) ? ($category->meta_description ?? $category->description ?? 'Khám phá các dịch vụ thẩm mỹ tại Dr.DAT.') : 'Khám phá các dịch vụ thẩm mỹ tại Dr.DAT.') }}" />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="{{ url()->current() }}" />
    <meta property="og:image" content="{{ isset($service) && $service->image ? Storage::url($service->image) : (isset($category) && $category->image ? Storage::url($category->image) : asset('images/logo_Dr_Dat.png')) }}" />
