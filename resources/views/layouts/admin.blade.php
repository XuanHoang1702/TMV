                ...
                <div class="admin-wrapper d-flex">
                    ...
                    <nav class="admin-sidebar bg-dark text-white vh-100 p-3" style="width: 250px;">
                        ...
                        <ul class="sidebar-menu list-unstyled">
                            ...
                            <li
                                class="{{ request()->routeIs('admin.menus.*') ? 'active bg-primary' : '' }} rounded mb-2">
                                <a href="{{ route('admin.menus.index') }}"
                                    class="d-flex align-items-center text-white text-decoration-none px-3 py-2">
                                    <i class="fas fa-bars me-2"></i>
                                    <span>Quản lý Menu</span>
                    ...
                    <div class="admin-main flex-grow-1">
                        <!-- Top Bar -->
                        <header
                            class="admin-header d-flex justify-content-between align-items-center p-3 border-bottom bg-light">
                            <div class="header-left">
                                <button class="btn btn-outline-secondary sidebar-toggle" onclick="toggleSidebar()">
                                    <i class="fas fa-bars"></i>
                                </button>
                            ...
                            <div class="header-right d-flex align-items-center">
                                ...
                                <div class="d-flex align-items-center ms-3">
                                    <button class="btn btn-sm btn-outline-primary me-2"
                                        onclick="translateLanguage('en')">EN</button>
                                    <button class="btn btn-sm btn-outline-success"
                                        onclick="translateLanguage('vi')">VI</button>
                                </div>
