            ...
            <div class="row cl-sec01" data-aos="zoom-in" data-aos-duration="3000">
                ...
                <div class="col-12 col-sm-12 cl-desc ">
                    <p class="ab-banner-desc">
                        Chúng tôi luôn sẵn sàng lắng nghe và hỗ trợ bạn trong hành trình chăm sóc sắc đẹp. Mọi thắc mắc, yêu cầu tư vấn hay đặt lịch hẹn,
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 cl-ct-info" data-aos="fade-left" data-aos-duration="3000">
                        <div class="cl-info">
                            ...
                            <p><i class="fa fa-map-marker"></i> Địa chỉ: <b>130 Lê Văn Thịnh, P. Bình Trưng Tây, TP. Thủ Đức</b></p>
            ...
            <div class="cl-panel-body">
                <div class="row">
                    <div class="col-12 col-sm-12 cl-info">
                        <h4>Hình ảnh bệnh viện</h4>
                    </div>
                </div>

                <div class="row">
                    <div class="col-12 col-sm-6" data-aos="zoom-in">
                        <img src="{{ asset('images/lienhe/l_h_image1.png') }}" />
                    </div>
                    <div class="col-12 col-sm-6" data-aos="zoom-in">
                        <img src="{{ asset('images/lienhe/l_h_image2.png') }}" />
                    </div>
                </div>
                <div class="row" style="margin-top:25px;">
                    <div class="col-12 col-sm-4" data-aos="zoom-in"><img src="{{ asset('images/lienhe/l_h_image3.png') }}" /></div>
                    <div class="col-12 col-sm-4" data-aos="zoom-in"><img src="{{ asset('images/lienhe/l_h_image4.png') }}" /></div>
                    <div class="col-12 col-sm-4" data-aos="zoom-in"><img src="{{ asset('images/lienhe/l_h_image5.png') }}" /></div>
                </div>
            </div>
        </div>
    </div>
