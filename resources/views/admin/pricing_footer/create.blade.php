...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0 text-gray-800">Thêm chú thích báo giá</h1>
            ...
            <div class="col-lg-8">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Thông tin báo giá</h6>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.pricing_footer.store') }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="content" name="content" rows="4" placeholder="Nhập nội dung" required>{{ old('content') }}</textarea>
                                @error('content')
