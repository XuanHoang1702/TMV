        ...
        <div class="card h-100">
            <div class="card-body text-center">
                @if(in_array($item->mime_type, ['image/jpeg', 'image/png', 'image/gif', 'image/webp']))
                    <img src="{{ asset('storage/' . $item->path) }}" class="img-fluid mb-3" style="max-height: 150px;" alt="{{ $item->name }}">
                ...
                <div class="btn-group w-100">
                    ...
                    <button class="btn btn-sm btn-danger" onclick="deleteMedia({{ $item->id }}, '{{ $item->name }}')">
